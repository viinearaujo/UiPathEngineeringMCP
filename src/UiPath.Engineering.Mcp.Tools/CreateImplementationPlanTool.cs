...
public sealed class CreateImplementationPlanTool {
    ...
    [McpServerTool(UseStructuredContent = true), Description("Creates an implementation plan for a UiPath project from a goal and an ordered task list. Writes docs/implementation-plan.json plus a Markdown mirror inside the project. Refuses to overwrite an existing plan unless overwrite is true. Next: get_implementation_plan.")]
