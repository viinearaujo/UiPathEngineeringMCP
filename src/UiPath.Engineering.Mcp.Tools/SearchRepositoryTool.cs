...
public sealed class SearchRepositoryTool {
    ...
    [McpServerTool(UseStructuredContent = true), Description("Searches GitLab issues in the configured project and returns matching issue summaries. Next: create_work_items.")]
