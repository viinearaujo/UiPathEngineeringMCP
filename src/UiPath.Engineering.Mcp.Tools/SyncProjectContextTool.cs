...
public sealed class SyncProjectContextTool {
    ...
    [McpServerTool(UseStructuredContent = true), Description("Regenerates generated project memory: AGENTS.md (marker-spliced block) and .claude/rules/project-context.md from the current project model. Next: validate_project_docs.")]
